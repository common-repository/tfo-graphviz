=== TFO Graphviz ===
Contributors: chrisy
Tags: graphviz, flirble, network, diagram, graph, dot, neato, twopi, circo, fdp, visualisation, visualization, layout, hierarchical, graph, digraph, svg, graphlib
...
[Graphviz](http://www.graphviz.org/) is a powerful tool for visualizing network and tree structures that connect objects.
...
* [http://blog.flirble.org/2010/11/12/graphviz-demo/](http://blog.flirble.org/2010/11/12/graphviz-demo/)
* [http://blog.flirble.org/2015/11/15/adding-svg-support-tfo-graphviz/](http://blog.flirble.org/2015/11/15/adding-svg-support-tfo-graphviz/)
* [http://blog.flirble.org/2019/06/22/gv-example-state-machine/](http://blog.flirble.org/2019/06/22/gv-example-state-machine/)
* [http://blog.flirble.org/2019/06/22/gv-example-various-graphs/](http://blog.flirble.org/2019/06/22/gv-example-various-graphs/)
...
* Experiment with the Graphlib-Dot JavaScript library. See [https://github.com/dagrejs/graphlib-dot/wiki](https://github.com/dagrejs/graphlib-dot/wiki).
...
* Add the SVG output format. See [http://blog.flirble.org/2015/11/15/adding-svg-support-tfo-graphviz/](http://blog.flirble.org/2015/11/15/adding-svg-support-tfo-graphviz/) for example. (Joachim Durchholz)
